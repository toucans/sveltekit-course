<script lang="ts">
	...
	function checkAvailability() {
		...
		debounceTimer = setTimeout(async () => {
			//The following code will only run if over 500 ms has elapsed since checkAvailability() was called. If checkAvailability() is called again before 500 ms elapses, clearTimeout reset it before the code got a chance to run.
